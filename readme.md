...
1. Go to your VS Code extensions folder:
   - **Path:** `%USERPROFILE%\.vscode\extensions`
   - *(Paste the path above into your File Explorer address bar)*

2. Move the folder `sagar.elementor-quick-snippets-0.0.1` into that directory.

3. Restart VS Code and check your extensions list.

> **Note:** If the extension does not appear, try renaming the folder to:  
> `sagar.elementor-snippets-0.0.1`
...
#### Custom Control: Color, Background, Border

Trigger | Description
--- | ---
elc_color | Color
elc_color_hover | Color Hover
elc_color_with_hover | Color With Hover (Tab)
elc_background | Background
elc_background_hover | Background Hover
elc_background_with_hover | Background With Hover (Tab)
elc_border_color | Border Color
elc_border_color_hover | Border Color Hover
elc_border_color_with_hover | Border Color With Hover (Tab)
elc_border_with_hover | Border With Hover (Tab)
elc_color_background_border_with_hover | Color, Background, Border With Hover (Tab)

#### Custom Control: Spacing and Alignment

Trigger | Description
--- | ---
elc_font_size | Font Size
elc_icon_size | Icon Size
elc_text_align | Text Align
elc_width | Width
elc_height | Height
elc_line_height | Line Height
elc_padding_top | Padding Top
elc_padding_right | Padding Right
elc_padding_bottom | Padding Bottom
elc_padding_left | Padding Left
elc_margin_top | Margin Top
elc_margin_right | Margin Right
elc_margin_bottom | Margin Bottom
elc_margin_left | Margin Left
elc_top_spacing | Top Spacing
elc_right_spacing | Right Spacing
elc_bottom_spacing | Bottom Spacing
elc_left_spacing | Left Spacing
elc_margin | Margin
elc_padding | Padding
elc_border_radius | Border Radius
elc_border_radius_slider | Border Radius Slider

#### Preset Control

Trigger | Description
--- | ---
elc_design_field | Design Content Field
elc_design_style_layout | Design Style
elc_design_markup | Design Markup
elc_section_title_content | Section Title (Content)
elc_section_title_style | Section Title (Style)
elc_section_subheading_content | Section Subheading (Content)
elc_section_subheading_style | Section Title (Style)
elc_section_description_content | Section Description (Content)
elc_section_description_style | Section Description (Style)
elc_icon_type_content | Icon Type Content
elc_icon_type_only_color | Icon Type Style Only Color
elc_icon_type_background | Icon Type Style Background
elc_icon_type_markup | Icon Type Markup
elc_icon_tag | Icon Tag
elc_image_variable | Image Variable
elc_image_tag | Image Tag
elc_slider_arrow_style | Slider Arrow Style
elc_slider_dot_style | Slider Dot Style
elc_link_content | Link Content
